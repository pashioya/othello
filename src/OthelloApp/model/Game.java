...
public class Game {
    ...
    private final static String GAME_SETUP_RULES ="""
    ...
    private final static String GAMEPLAY_RULES = """
    ...
    private final static String GAME_END_RULES = """
    ...
    // Creator Pattern
    public static GameSession createNewGameSession(boolean userGoesFirst, String userName, String difficultyMode){
